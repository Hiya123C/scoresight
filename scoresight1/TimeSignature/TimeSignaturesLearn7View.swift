//
//  TimeSignaturesLearn7View.swift
//  scoresight1
//
        ...
        NavigationStack {
            VStack {
                ...
                HStack {
                    ...
                    NavigationLink(destination: TimeSignaturesLearn8View(isPresented:$isPresented)) {
                        Text("next")
                            .padding()
                            .frame(width: 100, height: 50)
                            .background(
...
#Preview {
   ...
   TimeSignaturesLearn7View(isPresented: $isShowing)
}
