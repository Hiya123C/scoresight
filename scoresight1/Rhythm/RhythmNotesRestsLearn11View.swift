        ...
        NavigationStack {
            VStack {
                ...
                HStack(alignment: .top, spacing: 10) {
                    ...
                    VStack {
                        Image("dotted crochet rest")
                            .resizable()
                            .scaledToFit()
                            .frame(maxHeight: 190) // Limit max height
                    ...
                    VStack {
                        Image("dotted quaver rest")
                            .resizable()
                            .scaledToFit()
                            .frame(maxHeight: 170) // Limit max height
                        Image("dotted quaver")
                            .resizable()
                            .scaledToFit()
                            .frame(maxHeight: 100) // Limit max height
                ...
                HStack {
                    ...
                    NavigationLink(destination: RhythmNotesRestsLearn12View(isPresented:$isPresented)) {
                        Text("next")
                            .padding()
                            .frame(width: 100, height: 50)
                            .background(
...
#Preview {
    ...
    RhythmNotesRestsLearn11View(isPresented: $isShowing)
}
