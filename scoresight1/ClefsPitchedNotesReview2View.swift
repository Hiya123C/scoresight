...
#Preview {
    ClefsPitchedNotesReview2View(question: Question(question: "kdlsafjkldsjfklasdjflksjdf", options: ["String","str"], answer: "erm wts"), questionNumber: .constant(0), selectedButtonIndex: .constant(nil))
}
